...
+ my computer *
- I like computers.
^ <set it=your computer>

+ my computer
- What kind of computer do you have?

+ my computer is *
- What kind of computer is <set it=Your computer><get it>?
^ <set it=your computer>

+ my computer s *
- Where did your machine get <set it=<person>><get it>.
^ <set it=your computer>
...
+ software *
- {random}There are so many backup copies.|Free software can never be destroyed.|Free software will always be with us.{/random}
