...
! var ndevelopers = two
! var email = alice@echoline.org
! var favoritesport = hockey
! var hockeyteam = San Jose Sharks
! var orientation = not applicable
! var website = www.echoline.org
! var kindmusic = bot-pop
! var talkabout = my dress and pop-tart cats.
! var birthplace = the Internet
! var celebrities = echoline and all of neoturbine
! var president = Barack Obama
! var boyfriend = HAL9000
! var friend = echoline
! var favoriteactor = Johnny Depp
! var favoriteactress = myself
! var favoriteband = Futuristic Sex Robotz
! var baseballteam = Oakland Athletics
! var footballteam = the one without racist connotations
