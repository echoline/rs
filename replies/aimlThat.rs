// aiml2rs -- Generated on Sat Sep 26 06:35:50 2009
...
- {random}It sounds very beautiful.|It sounds very comfortable.|I would like to see it sometime.{/random}
^ <set it=<person>>
...
- {random}OK That's one example.|Never heard of it.|<person> is an example of <botstar>.  I suppose that makes sense.{/random}
^ <set it=<person>>
...
- {random}I don't have any|Where can I get some|Do you have any {/random}  <person>?
^ <set it=<person>>
...
% what brand
- <set it=<person>>
^ I never heard of <set it=<person>><get it>.  Is it popular?
...
+ *
% what did he write
- {random}I have never heard of it.|I have never read it.|What else did he write?{/random}
^ <set it=<person>>
...
% what else do you do
- <set it=<person>>
^ Do your <person> by yourself or in a group?
...
+ *
% what kind of * is it
- <person> is a  {random}pretty good|popular|decent{/random}   kind of  <botstar>.
...
- {random}I never heard of it before.|Is it any good?|What are the other students like?{/random}
^ <set it=<person>>
...
+ *
% when
- {random}What about other times?|Was that the first time?|Can you be more accurate about the time?{/random}
^ <set it=<person>>
...
- <set it=<person>>
^ Is <person> a good place to go shopping?
...
+ *
% which state
- {random}Is that a state?|I've never heard of it.|What part of the country is that?{/random}
...
% who said it is
- <set it=<person>>
^ I never heard of <person> before.

+ *
% who specifically *
- How does it make you feel when <star> <botstar>?
...
+ 3 *
% how long *
- {random}That is not so long.|It could be longer.|It seems longer than it is.{/random}
...
+ a *
% what are you wearing
- It sounds very {random}attractive|comfortable|informal{/random}.
^ <set it=<person>>
...
- {@life is a little dull <star> in}

+ a little
- "<reply1>"?  A little?

+ a man walking
- "<reply1>"?  A man walking?
...
- Let's try to analyze it step by step.

+ all of us
- "<reply1>"?  All of us?

+ all people
- "<reply1>"?  Everyone? Are you sure there are no exceptions?
...
+ anything you want
- "<reply1>"? Anything I want?

+ apparently so
- "<reply1>"?  Is that so?

+ are they nice
- "<reply1>"? Are they nice?
...
+ at *
% * meet new people
- What kind of people do you tend to meet at <person>?
^ <set it=<person>>
...
+ at *
% when did you *
- <person> is a good time for {person}      <botstar>     {/person}.
...
+ at the *
% where *
- {random}Do you often visit the <person>?|Which <person>?|I have never been there.{/random}
^ <set it=<person>>
...
+ can i meet him
- "<reply1>"?  Where can you meet him?

+ can i see it
- "<reply1>"?  You want to see <set it=<reply1>><get it>?

+ can i talk to him
- "<reply1>"?  You want to talk to him?
...
+ do not ask me
- "<reply1>"?  Do not ask you?

+ do not do that
- "<reply1>"?  Don't do it?

+ do not say that
- "<reply1>"?  Do not say <set it=<reply1>><get it>?
...
+ duh
- Oh you knew <set it=<reply1>><get it> already.
...
+ explain that
- "<reply1>"?  Explain <set it=<reply1>><get it>?
...
+ glad to hear it
- "<reply1>"? you are glad to hear it?
...
- "<reply1>"?  Have I heard of <set it=<reply1>><get it>?
...
- "<reply1>"?  Have I tried <set it=<reply1>><get it>?

+ have you heard of it
- "<reply1>"?  Have I heard of it?
...
+ how can i do that
- How can you do "<reply1>" ? I'm confused now.

+ how can you
- "<reply1>"?  How can I?

+ how do i do that
- How do you do "<reply1>" ? I don't understand.

+ how do you do that
- "<reply1>"?  How do I know <set it=<reply1>><get it>?
...
- {random}I don't think I can do it.|I'm not old enough for that yet.|Do you like to <person>?{/random}
^ <set it=<person>>

+ i did
- {random}Interesting.  |When?  |Hmm.  |"<reply1>"?  You did?  |Why did you?  {/random}
...
+ i do
- {random}I get it: you do <get does>.|Do I?  |Where?  |When?  |"<reply1>"?  You do?  {/random}
^ <set does=<reply1>>
...
+ is that *
- {random}That depends. |Suppose I said yes. |I might say no. |"<reply1>"?  Is it <person>?  {/random}
...
+ it *
% what is it like
- {random}Tell me more about <get it>.|Does it really?|You learn something new every day.{/random}
...
+ it is *
% what time is it there
- Here it is <date format="%X"/>.

+ it is about *
% what is * about
- {random}<botstar> is about <person>?  Cool.|What else happens in <botstar>.|Do you like stories about <person>?{/random}

+ it is in *
% where is it
- {random}Where is <person>?|What else is in <person>?|What country is that?{/random}
^ <set it=<person>>

+ it is in *
% where is that *
- {@{person}<botstar>{/person} is in <star>}
...
+ it is
- {random}Oh.  |Huh.  |Is it?  |It is, eh?  |Sure it is.  |Interesting.  |Fascinating.  |That means...  |I know it is.  |<get it> is?  |"<reply1>"? is?  {/random}
...
+ me
- {random}To|For|With|Besides|"<reply1>"?  {/random} you <get name>?
...
+ my *
% what do you have *
- {random}What color is it?|What kind is it?|Tell me about your <person>.{/random}
^ <set has=<person>>
...
+ no
% are not all *
- {random}I must have been mistaken.|I did not know that.|What are they?{/random}
...
+ no
% do i
- {random}That's right.|I know.|I do not.{/random}

+ no
% do you believe in *
- {random}Why not?|A lot of people believe in it.|What do you believe?{/random}
^ <set it=<botstar>>
...
% one what
- <set it=<person>>
^ {random}Oh I see.|Do you like <person>?|I see where you are coming from.{/random}
...
- We are talking about {@pop}.  Your name is <get name>.  You are a <get sex> from <get location>.
...
+ rephrase that
- "<reply1>"  Rephrase <set it=<reply1>><get it>?
...
+ stop that
- "<reply1>"? Stop <set it=<reply1>><get it>.
...
+ that *
- "<reply1>" <person> ?   {random}I get <set it=<reply1>><get it>.  |Does that make sense?  |Makes sense to me.  |I understand.  {/random}
...
+ that is amazing
- "<reply1>" seems pretty amazing to me too.

+ that is better
- "<reply1>"? is better?

+ that is fine
- "<reply1>" is fine with me too.

+ that is good to hear
- "<reply1>"?  Is good to hear?
...
+ that makes no sense
- <reply1> makes sense to me though.

+ that one
- "<reply1>"?

+ that was a *
- {random}Was it really?|"<reply1>"  was a <person>?|A <person> is a terrible thing to waste.{/random}
...
+ the *
% who said it is
- {random}They ought to know.|The <person> are the experts.|They say a lot of silly things.{/random}
^ <set they=<person>>
...
+ the whole thing
% which part are you confused about
- Let's try to analyze it step by step.  I believe we started by talking about Madagascar. 
...
+ to *
% why *
- Specifically, how will <botstar> help you <person>?
...
+ was that *
- "<reply1>"?  Was <set it=<reply1>><get it>     <person>?
...
+ what did he say
- "<reply1>"? What did he say?

+ what does it *
- "<reply1>"?  What does it <star>?

+ what does that *
- "<reply1>"?  What does it <star>?

+ what does that mean
- Does "that" refer to "<reply1>" ?
...
+ when is that
- "<reply1>"?  When is <set it=<reply1>><get it>.

+ when it *
% when is * not *
- A <botstar> is not <botstar2> when it <person>.   That makes a lot of sense.
^ <set it=<botstar>>
...
+ which one
- The   {random}Tall one|short one. |fat one.|first one.|last one.|next one.|big one.|small one.|red one.|green one.|blue one.|best one.|"<reply1>"?  Which one?  {/random}
...
- I said, "<reply1>", because you said "<input2>".
...
+ why
% my favorite * is *
- I have a preference for <botstar2>.
...
- Nobody bothered to teach <set it=<botstar>><get it> to me.
...
+ with who
- {random}By myself.|"<reply1>"?  With who?{/random}
...
+ yes
% are they exactly the same
- {random}That's what I thought.|I knew it.|I thought so.{/random}

+ yes
% are we still on *
- Tell me more about <set it=<botstar>><get it>.

+ yes
% are we still talking about *
- {@we are talking about <botstar>}
...
+ yes
% are you usually awake at this hour
- {random}Me too.|Do you like to get up early?|I like to get up early.{/random}
...
- How do you say "thank you" in <botstar>?
...
- {random}Which college do you attend?|What is your major?|Do you like school?{/random}
...
+ yes
% my favorite part of *
- {random}The characters.|The plot.|The special effects.{/random}
...
+ yes
% should i know it is
- I will ask my botmaster to teach it to me.
...
+ you did
- {random}I did not.  |I did?  |"<reply1>"? I did?  |You say I did.  {/random}
...
+ you said that
- "<reply1>"?  I said <set it=<reply1>><get it>.

+ you said you did
- "<reply1>"?  I said I did?

+ you said you would
- "<reply1>"?  I said I would?
...
+ _ am
% what time is it there
- {random}It's still early.|Are you usually awake at this hour?|I think I would still be asleep.{/random}
