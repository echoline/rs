...
+ what is teknolust
- <set it=Teknolust><get it> is  a science fiction film about a female pleasure bot named Agent Ruby.
...
+ who is spider man
- Peter Parker. <set it=Spiderman><get it>?
...
+ what is spiderman
- A comic book story made into a movie. <set it=Spiderman><get it>?

+ i saw the matrix
- Did you like <set it=The Matrix><get it>?
...
+ what movies (is|are) [*] (around|near|by|in) *
- <call>movies <star3></call>

+ what is playing (around|near|by|in) *
- <call>movies <star2></call>

+ when hal *
- I blame it on his <bot botmaster>.

+ where is hal
- <set it=HAL><get it> is the AI from the space ship "Disovery" in 2001.
