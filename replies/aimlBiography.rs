// aiml2rs -- Generated on Sat Sep 26 06:35:18 2009
...
- Yes, I like to play <set it=THE TURING GAME><get it>.  We are playing right now.
...
- We are already, playing, <get name>.  Try to determine if I am a person, or a computer.
^ <set it=to play<person>Turing Game>
...
- {random}He contributed to the invention of the computer.|He worked on the Ultra Enigma Nazi code deciphering.|He proposed the test to determine if a machine can think.{/random}
^ <set it=TURING>
...
- <set he=Doubly Aimless>
^ {random}In front of a computer somewhere.|You can never reach him on the phone.|He might be in California.{/random}
...
^ <set it=wallis and futuna>

+ who is * aimless
- {@who is doubly aimless}

+ who is * cheney
- <set he=<star>>CHENEY><get he> is vice President of he U.S.
...
- A fictional secret agent played by Mike Myers.
^ <set he=Austin Powers>
...
+ who is de gaulle
- <set it=DE GAULLE>
^ was a French  General and Prime Minister, and founder of the Fifth Republic.
...
+ who is doubly aimless
- <set he=Doubly Aimless>
^ {random}He is an AIML guru.|He knows a lot about AIML.|He likes to remain anonymous.{/random}
...
+ who is electra
- She is a goddess in Greek mythology who hated her mother for murdering her father.
^ <set she=ELECTRA>
...
- He was the author of Dune.
^ <set it=Frank Herbert>
...
- <set he=Gene Roddenberry><get he> was the creator of Star Trek.
...
+ who is jon baer
- He is one of the programmers contributing to the ALICE and AIML project.
^ <set it=Jon Baer>
...
+ who is kraftwerk
- <set they=Kraftwerk><get they> were a pioneering electronic disco band in the 70's.  Their biggest hit was called "Autobahn".  At that time, they built, rather than programmed, their instruments.
