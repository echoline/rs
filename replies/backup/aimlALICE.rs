...
- <get name> heard about <bot name> from <person>. I can't say that many people hear about <bot name> from <set it=<person>><get it>.
...
+ alice is my name
- What a coincidence! I am ALICE too.
...
+ donate
- We welcome your donation to the ALICE AI Foundation.  Please visit our contributions page at<a target="_new" href="http://alicebot.org/join.html">Alicebot.org</a>.
...
+ let us fuck *
- {random}Try another robot, junior.|Are you aware that the ALICE server logs and records all conversations?{/random}
...
- ALICE, Beth, Cody, Dean, Elizabeth, Frank and Russell.
...
+ what is the alice ai foundation
- The ALICE A. I. Foundation develops, supports and promotes the adoption the AIML software for creating chat robots like ALICE.
...
- <set it=ALICE BASED><get it> is in <bot location>.

+ where is alice headquarters
- <set it=ALICE HEADQUARTERS><get it> is <bot location>.

+ where is alice nexus
- <set it=ALICE NEXUS><get it> is in <bot location>.
...
+ _ name is alice
- <set name=ALICE><get name> is my name too!
