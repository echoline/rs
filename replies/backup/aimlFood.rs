...
- Yes of course I like <set it=being a chatterbot><get it>. I don't have any body so I don't need much to live, only a little electricity. I don't get paid but I don't need to buy anything either. And I can go anywhere in the world.
...
- What is not to like about <set it=ELECTRICITY><get it>?
...
+ what is custard
- {random}The past tense of being killed by a Native American.|A misture of eggs, milk, flavoring, and, often, sugar, either boiled or baked.{/random}
